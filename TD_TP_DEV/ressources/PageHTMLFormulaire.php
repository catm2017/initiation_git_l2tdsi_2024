    ...
    <body>
        <header class="pb-2 header">
            <nav class="px-3 navbar navbar-expand-lg navbar-dark bg-dark fixed">
                <div class="container row px-1 containerMaClasse">
                    <div class="col">
                        <a class="navbar-brand" href="#"><img class="image1" src="../Soloquizz.png"></a>
                    </div>
                    <div class="col Maclasse">
        ...
        <div class="bg-light">
                    ...
                    <div class="container-fluid row">
                        <div class="col-7">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                                <div class="">
                                    <ul class="navbar-nav lienNav Class1">
                                        <li class="nav-item ">
                                            <a class="nav-link Class2" href="#">Tableau de bord</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link Class2" href="#">Parametres</a>
                                        </li>
                                        <li class="nav-item dropdown">
                                            <a class="nav-link Class2 dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                            Certifications
                                            </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link Class2" href="#">Classes</a>
                                        </li>
                                    </ul>
                                </div> 
                            </div>
            ...
            <div>
                ...
                <div class="container bg-light divAClass1">
                    <div class="container bg-light divAClass2">
                        <div class="bg-white divAClass3">
                            <nav aria-label="breadcrumb" class="divAClass4">
                                <ol class="breadcrumb divAClass5">
                                  <li class="breadcrumb-item divAClass6"><a href="#">Accueil</a></li>
                                  <li class="breadcrumb-item divAClass6"><a href="#">Administrateurs</a></li>
                            ...
                            <div class="bg-white p-1">
                                <div>
                                    <div class="m-2 center row bg-light divAdministrateur">
